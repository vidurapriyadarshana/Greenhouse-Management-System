...
import com.example.sensor_service.service.TelemetryScheduler;
...
@Service
public class TelemetrySchedulerImpl implements TelemetryScheduler {

    private static final Logger logger = LoggerFactory.getLogger(TelemetrySchedulerImpl.class);

    private final ExternalIoTService externalIoTService;
    private final AutomationClient automationClient;
    private final SensorService sensorService;

    public TelemetrySchedulerImpl(ExternalIoTService externalIoTService,
